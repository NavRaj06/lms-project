...
import Icon1 from "../assets/Images/hands-on-practice.png";
import Icon2 from "../assets/Images/certificate.png";
import Icon3 from "../assets/Images/empty-state-1.png";
import Icon4 from "../assets/Images/organizations-2.png";
                ...
                >
                  <div className="flex flex-col xl:flex-row w-full items-stretch xl:items-center">
                    ...
                    <div className="flex flex-col ml-5 text-left">
                      <p className="text-lg text-black capitalize">{label}</p>
